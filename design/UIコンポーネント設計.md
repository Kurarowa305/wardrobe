...
| テンプレート追加     | AppLayout（tabなし）, Screen          | Header（title=テンプレートの追加）, BackButton                      | -                                             | TemplateForm（initial空）, ClothingMultiSelect, TextField, TemplateNameSuggestion, PrimaryButton（追加）    | ConfirmDialog（破棄確認）          |
| テンプレート編集     | AppLayout（tabなし）, Screen          | Header（title=テンプレートの編集）, BackButton                      | -                                             | TemplateForm（initial=現在値）, ClothingMultiSelect, TextField, TemplateNameSuggestion, PrimaryButton（保存） | ConfirmDialog（破棄確認）          |
