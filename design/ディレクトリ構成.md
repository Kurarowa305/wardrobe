...
* `app/` はルーティングのみ（薄く）
* 画面UIは `components/app/screens/*Screen.tsx` に配置し、`page.tsx` から呼び出す
...
apps/web/
  scripts/
    check-routing-spec.mjs        # ルーティング仕様チェック（CI実行）
    check-query-id-routing-spec.mjs # ID query ルーティング仕様チェック（CI実行）
  src/
    app/
      page.tsx                    # / -> /wardrobes/new リダイレクト
      home/page.tsx               # /home?wardrobeId=...
      histories/page.tsx          # /histories?wardrobeId=...
      histories/detail/page.tsx   # /histories/detail?wardrobeId=...&historyId=...
      templates/page.tsx          # /templates?wardrobeId=...
      templates/new/page.tsx      # /templates/new?wardrobeId=...
      templates/detail/page.tsx   # /templates/detail?wardrobeId=...&templateId=...
      templates/edit/page.tsx     # /templates/edit?wardrobeId=...&templateId=...
      clothings/page.tsx          # /clothings?wardrobeId=...
      clothings/new/page.tsx      # /clothings/new?wardrobeId=...
      clothings/detail/page.tsx   # /clothings/detail?wardrobeId=...&clothingId=...
      clothings/edit/page.tsx     # /clothings/edit?wardrobeId=...&clothingId=...
      record/page.tsx             # /record?wardrobeId=...
      record/template/page.tsx    # /record/template?wardrobeId=...
      record/combination/page.tsx # /record/combination?wardrobeId=...
      wardrobes/
        new/page.tsx              # Screen呼び出しのみ（ワードローブ作成）
