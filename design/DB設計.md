...
| AP-04a | ホーム：おすすめ服           | Query（GSI: StatusListByLastWornAt）       | Clothing                                  | PK=`W#<wardrobeId>#CLOTH#ACTIVE`、SK=`LASTWORN#...`、`ScanIndexForward=true`                                                                                                                                                                                                                                                                                         | 季節タグとgenreはAPI側で判定し、トップス/ボトムス各2件まで取得 |
