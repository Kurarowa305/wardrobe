...
export function SharedHistoryCard({
  wardrobeId,
  item,
  from,
}: SharedHistoryCardProps) {
  const combinationTitle = item.clothingItems
    .map((clothingItem) => clothingItem.name)
    .join("+");
