...
check("CT-03", "一覧/詳細レスポンスDTOに genre を含み nextCursor を持たない", includes("src/api/schemas/clothing.ts", 'export type ClothingListItemDto = Pick<ClothingDto, "clothingId" | "name" | "genre" | "imageKey">;') && !includes("src/api/schemas/clothing.ts", 'nextCursor: string | null;'), "一覧DTOの genre または nextCursor 削除が不足しています");
