...
check("RCS-07", "ジャンルごとに limit=100 で取得し『さらに読み込む』を持たない", includes(target, 'const RECORD_COMBINATION_CLOTHING_LIMIT = 100;') && !includes(target, 'handleLoadMore') && !includes(target, 'loadMoreLabel={RECORD_STRINGS.byCombination.actions.loadMore}'), "一括取得または load more 削除が不足しています");
