...
check("TF-04", "服一覧取得はジャンル別 limit=100 指定で cursor や追加読み込みを持たない", includes("src/components/app/screens/TemplateForm.tsx", 'const TEMPLATE_FORM_CLOTHING_LIMIT = 100;') && includes("src/components/app/screens/TemplateForm.tsx", 'genre: "tops"') && !includes("src/components/app/screens/TemplateForm.tsx", 'handleLoadMore(genre)') && !includes("src/components/app/screens/TemplateForm.tsx", 'loadMoreClothings'), "ジャンル別一括取得または追加読み込み削除が不足しています");
