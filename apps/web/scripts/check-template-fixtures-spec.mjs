...
check("TF-08", "templateDetailFixtures が自動読み込み検証用に30件超で構成される", includes("src/mocks/fixtures/template.ts", 'const GENERATED_TEMPLATE_FIXTURE_COUNT = 31;') && includes("src/mocks/fixtures/template.ts", '...Array.from({ length: GENERATED_TEMPLATE_FIXTURE_COUNT },'), "30件超構成の定義が不足しています");
