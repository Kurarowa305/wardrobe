...
check("CF-06", "トップス・ボトムス・その他それぞれに10件以上の fixture を用意する", includes("src/mocks/fixtures/clothing.ts", "const GENERATED_FIXTURES_PER_GENRE = 12;") && includes("src/mocks/fixtures/clothing.ts", 'const FIXTURE_GENRE_ORDER = ["tops", "bottoms", "others"]'), "各ジャンル10件以上の fixture 定義が不足しています");
