...
check("CA-05", "一覧APIは genre/order/limit/cursor を query として渡せる", includes("src/api/schemas/clothing.ts", 'genre?: ClothingGenreDto;') && includes("src/api/schemas/clothing.ts", 'order?: ClothingListOrderDto;') && includes("src/api/schemas/clothing.ts", 'limit?: number;') && includes("src/api/schemas/clothing.ts", 'cursor?: string | null;') && includes("src/api/endpoints/clothing.ts", 'query: params,'), "一覧 query に genre/order/limit/cursor が不足しています");
