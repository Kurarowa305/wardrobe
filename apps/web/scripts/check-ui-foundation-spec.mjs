...
const DIRECT_RENDERING_FILES = new Set([
  "src/components/app/screens/WardrobeCreateScreen.tsx",
  "src/components/app/screens/HistoriesTabScreen.tsx",
  "src/components/app/screens/ClothingsTabScreen.tsx",
  "src/components/app/screens/TemplatesTabScreen.tsx",
...
check(
  "UF-09",
  "スクリーン実装は ScreenCard を使わず Card または直接描画で構成される",
  noIncludes(
    "src/components/app/screens/ScreenPrimitives.tsx",
    ...
    SCREEN_FILES.every((file) => {
      ...
      if (DIRECT_RENDERING_FILES.has(file)) {
        ...
        return !source.includes("ScreenCard") && directRenderingGuard;
      }
      ...
      return (
        ...
        (source.includes("<Card") || source.includes("createElement(Card")) &&
        (source.includes("<CardContent") ||
          source.includes("createElement(CardContent"))
      );
    }),
