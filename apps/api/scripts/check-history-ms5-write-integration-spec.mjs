...
const runScenario = async () => {
  ...
  assertState(state.wearDaily.get(buildDailyKeyString("wd_001", { kind: "clothing", id: "cl_001" }, "20260105")) === 1,
    "template create should increment clothing cl_001 wearDaily for template date", state.wearDaily);
  assertState(state.wearDaily.get(buildDailyKeyString("wd_001", { kind: "clothing", id: "cl_002" }, "20260105")) === 1,
    "template create should increment clothing cl_002 wearDaily for template date", state.wearDaily);
  ...
  assertState(clothing1AfterTemplateCreate?.wearCount === 4,
    "template create should increment clothing cl_001 wearCount", clothing1AfterTemplateCreate);
  assertState(clothing2AfterTemplateCreate?.wearCount === 2,
    "template create should increment clothing cl_002 wearCount", clothing2AfterTemplateCreate);
  assertState(clothing1AfterTemplateCreate?.lastWornAt === toEpochMs("20260105"),
  ...
  assertState(clothing1AfterTemplateDelete?.wearCount === 4,
    "template delete should revert clothing cl_001 wearCount by template contribution", clothing1AfterTemplateDelete);
  assertState(clothing2AfterTemplateDelete?.wearCount === 2,
    "template delete should revert clothing cl_002 wearCount by template contribution", clothing2AfterTemplateDelete);
  assertState(!state.wearDaily.has(buildDailyKeyString("wd_001", { kind: "clothing", id: "cl_001" }, "20260105")),
    "template delete should remove clothing cl_001 wearDaily on template date", state.wearDaily);
  assertState(!state.wearDaily.has(buildDailyKeyString("wd_001", { kind: "clothing", id: "cl_002" }, "20260105")),
    "template delete should remove clothing cl_002 wearDaily on template date", state.wearDaily);
